...
\addfootobject(c:.5\paperwidth){BIG}
\addfootobject*(c:.25\paperwidth){small}
\addfoottext(l:25cm){sponsors}
%\addfootqrcode(l:3cm)[project web page]{http://ta.twi.tudelft.nl/users/nw/zwieten}
...
\begin{itemize}
  \item Quisque vehicula, urna sed ultricies auctor, pede lorem egestas dui, et convallis elit erat sed nulla.
  \item Donec luctus.
